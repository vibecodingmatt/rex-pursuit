...
- **Shipped 2026-09-24:** Drops 1, 1b and most of 2 are live (`770ec45`). Drop 2's remainder and Drop 3 are committed on `aaa-upgrade`, not shipped. Next up: Drop 4 (plus any mix or effect tweaks from the user's play-test).
