...
- **Shipped 2026-09-24:** Drops 1–5 are live (`8d9fa60`), along with fixes for the menu layout, rain streaks, eye shine and mobile sky precision. `main` and `aaa-upgrade` match. Next up: Drop 6.
