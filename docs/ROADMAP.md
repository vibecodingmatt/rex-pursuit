...
- **Shipped 2026-09-24:** Drops 1, 1b and most of 2 are live (`770ec45`). Drop 2's remainder and Drops 3, 4 and 5 are committed on `aaa-upgrade`, not shipped. Next up: Drop 6, plus any mix, effect or night-lighting tweaks from the user's play-test.
