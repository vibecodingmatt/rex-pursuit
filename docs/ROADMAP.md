...
- **Shipped 2026-09-24:** Drops 1, 1b and most of 2 are live (`770ec45`). Next up: finish Drop 2 (HRTF 3D Rex voice, forest reverb, mix tweaks from the user), then Drop 3.
