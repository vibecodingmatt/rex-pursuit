...
- **Shipped 2026-09-24:** Drops 1, 1b and most of 2 are live (`770ec45`). Drop 2's remainder, Drop 3 and Drop 4 are committed on `aaa-upgrade`, not shipped. Next up: Drop 5 (plus any mix or effect tweaks from the user's play-test).
